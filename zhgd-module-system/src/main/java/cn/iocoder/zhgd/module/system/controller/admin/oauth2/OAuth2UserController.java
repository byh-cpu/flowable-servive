...
import cn.iocoder.zhgd.module.system.controller.admin.oauth2.vo.user.OAuth2UserInfoRespVO;
import cn.iocoder.zhgd.module.system.controller.admin.oauth2.vo.user.OAuth2UserUpdateReqVO;
...
public class OAuth2UserController {
    ...
    public CommonResult<Boolean> updateUserInfo(@Valid @RequestBody OAuth2UserUpdateReqVO reqVO) {
        ...
        userService.updateUserProfile(getLoginUserIdLong(), BeanUtils.toBean(reqVO, UserProfileUpdateReqVO.class));
        return success(true);
    }
