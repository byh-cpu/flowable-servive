package cn.iocoder.zhgd.module.system.controller.admin.user;
...
import cn.iocoder.zhgd.module.system.convert.user.UserConvert;
...
public class UserProfileController {
    ...
    public CommonResult<Boolean> updateUserProfile(@Valid @RequestBody UserProfileUpdateReqVO reqVO) {
        userService.updateUserProfile(getLoginUserIdLong(), reqVO);
        return success(true);
    }
    ...
    public CommonResult<Boolean> updateUserProfilePassword(@Valid @RequestBody UserProfileUpdatePasswordReqVO reqVO) {
        userService.updateUserPassword(getLoginUserIdLong(), reqVO);
        return success(true);
    }
