package cn.iocoder.zhgd.module.system.controller.admin.notify;
...
import cn.iocoder.zhgd.module.system.controller.admin.notify.vo.message.NotifyMessageRespVO;
import cn.iocoder.zhgd.module.system.dal.dataobject.notify.NotifyMessageDO;
import cn.iocoder.zhgd.module.system.service.notify.NotifyMessageService;
...
public class NotifyMessageController {
    ...
    public CommonResult<PageResult<NotifyMessageRespVO>> getMyMyNotifyMessagePage(@Valid NotifyMessageMyPageReqVO pageVO) {
        PageResult<NotifyMessageDO> pageResult = notifyMessageService.getMyMyNotifyMessagePage(pageVO,
                getLoginUserIdLong(), UserTypeEnum.ADMIN.getValue());
        return success(BeanUtils.toBean(pageResult, NotifyMessageRespVO.class));
    }
    ...
    public CommonResult<Boolean> updateNotifyMessageRead(@RequestParam("ids") List<Long> ids) {
        notifyMessageService.updateNotifyMessageRead(ids, getLoginUserIdLong(), UserTypeEnum.ADMIN.getValue());
    ...
    public CommonResult<Boolean> updateAllNotifyMessageRead() {
        notifyMessageService.updateAllNotifyMessageRead(getLoginUserIdLong(), UserTypeEnum.ADMIN.getValue());
        return success(Boolean.TRUE);
    }
    ...
    public CommonResult<List<NotifyMessageRespVO>> getUnreadNotifyMessageList(
        ...
        List<NotifyMessageDO> list = notifyMessageService.getUnreadNotifyMessageList(
                getLoginUserIdLong(), UserTypeEnum.ADMIN.getValue(), size);
