package cn.iocoder.zhgd.module.system.controller.admin.oauth2;
...
import cn.iocoder.zhgd.framework.common.util.http.HttpUtils;
import cn.iocoder.zhgd.framework.common.util.json.JsonUtils;
import cn.iocoder.zhgd.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import cn.iocoder.zhgd.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import cn.iocoder.zhgd.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import cn.iocoder.zhgd.module.system.convert.oauth2.OAuth2OpenConvert;
import cn.iocoder.zhgd.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.iocoder.zhgd.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import cn.iocoder.zhgd.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.iocoder.zhgd.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import cn.iocoder.zhgd.module.system.service.oauth2.OAuth2ApproveService;
import cn.iocoder.zhgd.module.system.service.oauth2.OAuth2ClientService;
import cn.iocoder.zhgd.module.system.service.oauth2.OAuth2GrantService;
import cn.iocoder.zhgd.module.system.service.oauth2.OAuth2TokenService;
import cn.iocoder.zhgd.module.system.util.oauth2.OAuth2Utils;
...
import static cn.iocoder.zhgd.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.iocoder.zhgd.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    public CommonResult<OAuth2OpenAuthorizeInfoRespVO> authorize(@RequestParam("clientId") String clientId) {
        ...
        // 2. 获得用户已经授权的信息
        List<OAuth2ApproveDO> approves = oauth2ApproveService.getApproveList(getLoginUserIdLong(), getUserType(), clientId);
        // 拼接返回
    ...
    public CommonResult<String> approveOrDeny(@RequestParam("response_type") String responseType,
        ...
        if (Boolean.TRUE.equals(autoApprove)) {
            ...
            if (!oauth2ApproveService.checkForPreApproval(getLoginUserIdLong(), getUserType(), clientId, scopes.keySet())) {
                return success(null);
            }
        } else { // 2.2 假设 approved 非 null，说明是场景二
            // 如果计算后不通过，则跳转一个错误链接
            if (!oauth2ApproveService.updateAfterApproval(getLoginUserIdLong(), getUserType(), clientId, scopes)) {
        ...
        if (grantTypeEnum == OAuth2GrantTypeEnum.AUTHORIZATION_CODE) {
            return success(getAuthorizationCodeRedirect(getLoginUserIdLong(), client, approveScopes, redirectUri, state));
        }
        // 3.2 如果是 token 则是 implicit 简化模式，则发送 accessToken 访问令牌，并重定向
        return success(getImplicitGrantRedirect(getLoginUserIdLong(), client, approveScopes, redirectUri, state));
    }
