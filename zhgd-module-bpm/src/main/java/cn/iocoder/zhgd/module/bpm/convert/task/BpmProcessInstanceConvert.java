package cn.iocoder.zhgd.module.bpm.convert.task;
...
import cn.iocoder.zhgd.module.bpm.controller.admin.definition.vo.process.BpmProcessDefinitionRespVO;
import cn.iocoder.zhgd.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO;
import cn.iocoder.zhgd.module.bpm.controller.admin.task.vo.instance.BpmProcessInstanceBpmnModelViewRespVO;
import cn.iocoder.zhgd.module.bpm.controller.admin.task.vo.instance.BpmProcessInstanceRespVO;
import cn.iocoder.zhgd.module.bpm.controller.admin.task.vo.instance.BpmProcessPrintDataRespVO;
import cn.iocoder.zhgd.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.iocoder.zhgd.module.bpm.convert.definition.BpmProcessDefinitionConvert;
...
import cn.iocoder.zhgd.module.bpm.api.event.BpmProcessInstanceStatusEvent;
...
public interface BpmProcessInstanceConvert {
    ...
    default PageResult<BpmProcessInstanceRespVO> buildProcessInstancePage(PageResult<HistoricProcessInstance> pageResult,
        ...
        for (int i = 0; i < pageResult.getList().size(); i++) {
            ...
            // user
            if (userMap != null) {
                AdminUserRespDTO startUser = userMap.get(NumberUtil.parseLong(pageResult.getList().get(i).getStartUserId(), null));
                if (startUser != null) {
