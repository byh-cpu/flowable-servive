...
public class BpmTaskCandidateAssignEmptyStrategy implements BpmTaskCandidateStrategy {
    ...
    private Set<String> getCandidateUsers(String processDefinitionId, FlowElement flowElement) {
        // 情况一：指定人员审批
        ...
        if (Objects.equals(assignEmptyHandlerType, BpmUserTaskAssignEmptyHandlerTypeEnum.ASSIGN_USER.getType())) {
            return new HashSet<>(cn.iocoder.zhgd.framework.common.util.collection.CollectionUtils.convertList(
                    BpmnModelUtils.parseAssignEmptyHandlerUserIds(flowElement), String::valueOf));
        }
