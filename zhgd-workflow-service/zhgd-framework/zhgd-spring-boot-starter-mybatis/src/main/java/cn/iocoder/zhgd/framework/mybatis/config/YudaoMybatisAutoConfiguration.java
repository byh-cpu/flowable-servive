package cn.iocoder.zhgd.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.iocoder.zhgd.framework.common.util.json.JsonUtils;
import cn.iocoder.zhgd.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${zhgd.info.base-package}", annotationClass = Mapper.class,
