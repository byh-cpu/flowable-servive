package cn.iocoder.zhgd.framework.websocket.config;

import cn.iocoder.zhgd.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import cn.iocoder.zhgd.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.zhgd.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.iocoder.zhgd.framework.websocket.core.listener.WebSocketMessageListener;
import cn.iocoder.zhgd.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.iocoder.zhgd.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.iocoder.zhgd.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.iocoder.zhgd.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.iocoder.zhgd.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.iocoder.zhgd.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.iocoder.zhgd.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.iocoder.zhgd.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.iocoder.zhgd.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.iocoder.zhgd.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.iocoder.zhgd.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.iocoder.zhgd.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.iocoder.zhgd.framework.websocket.core.session.WebSocketSessionManager;
import cn.iocoder.zhgd.framework.websocket.core.session.WebSocketSessionManagerImpl;
