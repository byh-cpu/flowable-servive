package cn.iocoder.zhgd.module.infra.service.logger;
...
import cn.iocoder.zhgd.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.iocoder.zhgd.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.iocoder.zhgd.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.iocoder.zhgd.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.iocoder.zhgd.framework.common.util.date.LocalDateTimeUtils.*;
...
import static cn.iocoder.zhgd.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.iocoder.zhgd.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("zhgd-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("zhgd-test");
